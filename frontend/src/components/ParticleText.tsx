...
export default function ParticleText({
  ...
  useEffect(() => {
    ...
    // ✅ THE FIX: Replaced requestAnimationFrame with setTimeout
    const queueSample = () => {
      if (resizeFrame) window.clearTimeout(resizeFrame);
      resizeFrame = window.setTimeout(sampleText, 250) as unknown as number;
    };
    ...
    return () => {
      ...
      // ✅ THE FIX: clear the timeout on unmount
